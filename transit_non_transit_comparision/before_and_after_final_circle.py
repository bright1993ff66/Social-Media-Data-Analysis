...
class TransitNeighborhood_before_after(object):
    ...
    def line_map_comparison(self, line_labels:tuple, ylabel:str, plot_title_name:str, saving_path:str,
        ...
        :param saving_path: the path for saving the created plots
        ...
        lns1 = ax.plot(x, y1, '#4659FF', label=line_labels[0], linestyle='--', marker='^')
        lns2 = ax.plot(x, y2, '#FFA238', label=line_labels[1], linestyle='--', marker='^')
        ...
        fig.savefig(os.path.join(saving_path, saving_file_name))
        plt.show()
...
if __name__ == '__main__':
    ...
    # Load the treatment, control dataframes
    ...
    kwun_tong_line_control_1000_dataframe = pd.read_csv(os.path.join(dataframe_path, 'whampoa_control_1000_annulus.csv'),
                                                        encoding='utf-8', quoting=csv.QUOTE_NONNUMERIC)
    kwun_tong_line_control_1500_dataframe = pd.read_csv(os.path.join(dataframe_path, 'whampoa_control_1500_annulus.csv'),
                                                        encoding='utf-8', quoting=csv.QUOTE_NONNUMERIC)
    south_horizons_treatment_dataframe = pd.read_csv(os.path.join(dataframe_path, 'south_horizons_treatment.csv'),
                                                     encoding='utf-8', quoting=csv.QUOTE_NONNUMERIC)
    south_horizons_control_1000_dataframe = pd.read_csv(os.path.join(dataframe_path,
                                                                     'south_horizons_control_1000_annulus.csv'),
                                                     encoding='utf-8', quoting=csv.QUOTE_NONNUMERIC)
    ...
    ocean_park_treatment_dataframe = pd.read_csv(os.path.join(dataframe_path, 'ocean_park_treatment.csv'),
                                                     encoding='utf-8', quoting=csv.QUOTE_NONNUMERIC)
    ocean_park_control_1000_dataframe = pd.read_csv(os.path.join(dataframe_path, 'ocean_park_control_1000_annulus.csv'),
                                                 encoding='utf-8', quoting=csv.QUOTE_NONNUMERIC)
    ocean_park_control_1500_dataframe = pd.read_csv(os.path.join(dataframe_path, 'ocean_park_control_1500_annulus.csv'),
                                                    encoding='utf-8', quoting=csv.QUOTE_NONNUMERIC)

    # whole_treatment_dataframe = pd.read_csv(os.path.join(dataframe_path, 'whole_treatment.csv'),
    #                                         encoding='utf-8', quoting=csv.QUOTE_NONNUMERIC)
    #
    # whole_control_dataframe = pd.read_csv(os.path.join(dataframe_path, 'whole_control.csv'),
    #                                         encoding='utf-8', quoting=csv.QUOTE_NONNUMERIC)

    kwun_tong_line_extension_1000_control = \
        TransitNeighborhood_before_after(tn_dataframe=kwun_tong_line_treatment_dataframe,
                                         non_tn_dataframe=kwun_tong_line_control_1000_dataframe,
                                         oct_open=True, before_and_after=True, compute_positive=False,
                                         compute_negative=False)
    kwun_tong_line_extension_1500_control = \
        TransitNeighborhood_before_after(tn_dataframe=kwun_tong_line_treatment_dataframe,
                                         non_tn_dataframe=kwun_tong_line_control_1500_dataframe,
                                         oct_open=True, before_and_after=True, compute_positive=False,
                                         compute_negative=False)
    south_horizons_1000_control = TransitNeighborhood_before_after(tn_dataframe=south_horizons_treatment_dataframe,
                                         non_tn_dataframe=south_horizons_control_1000_dataframe,
                                         oct_open=False, before_and_after=True, compute_positive=False,
                                         compute_negative=False)
    south_horizons_1500_control = TransitNeighborhood_before_after(tn_dataframe=south_horizons_treatment_dataframe,
                                                                   non_tn_dataframe=south_horizons_control_1500_dataframe,
                                                                   oct_open=False, before_and_after=True,
                                                                   compute_positive=False,
                                                                   compute_negative=False)
    ocean_park_1000_control = TransitNeighborhood_before_after(tn_dataframe=ocean_park_treatment_dataframe,
                                                                   non_tn_dataframe=ocean_park_control_1000_dataframe,
                                                                   oct_open=False, before_and_after=True,
                                                                   compute_positive=False,
                                                                   compute_negative=False)
    ocean_park_1500_control = TransitNeighborhood_before_after(tn_dataframe=ocean_park_treatment_dataframe,
                                                               non_tn_dataframe=ocean_park_control_1500_dataframe,
                                                               oct_open=False, before_and_after=True,
                                                               compute_positive=False,
                                                               compute_negative=False)
    ...
    print('***treatment vs 1000 control****')
    south_horizons_1000_control.compute_abs_coeff_difference()
    print('***treatment vs 1500 control****')
    south_horizons_1500_control.compute_abs_coeff_difference()
    print('-------------------------------------------------------------------------------')

    print('--------------------Ocean Park & Wong Chuk Hang Line Extension-------------------')
    print('***treatment vs 1000 control****')
    ocean_park_1000_control.compute_abs_coeff_difference()
    print('***treatment vs 1500 control****')
    ocean_park_1500_control.compute_abs_coeff_difference()
    print('-------------------------------------------------------------------------------')

    plot_saving_path = os.path.join(read_data.transit_non_transit_comparison_before_after, 'circle_annulus',
                                    'tweet_for_three_areas', 'plots')
    kwun_tong_line_extension_1500_control.line_map_comparison(
        line_labels=('Treatment Group', 'Control Group(1500 meter)'),
        ...
        saving_path=plot_saving_path,
        saving_file_name='kwun_tong_line_sentiment_treatment_control_comparison_1500_meter_annulus.png')
    kwun_tong_line_extension_1500_control.line_map_comparison(
        line_labels=('Treatment Group', 'Control Group(1500 meter)'),
        ...
        plot_title_name='Kwun Tong Line Treatment Group and Control Group Comparison',
        saving_path=plot_saving_path,
        saving_file_name='kwun_tong_line_activity_treatment_control_comparison_1500_meter_annulus.png')

    south_horizons_1500_control.line_map_comparison(
        line_labels=('Treatment Group', 'Control Group(1500 meter)'),
        ylabel='Percentage of Positive Tweets Minus Percentage of Negative Tweets',
        draw_sentiment=True,
        plot_title_name='South Horizons & Lei Tung Treatment Group and Control Group Comparison',
        saving_path=plot_saving_path,
        saving_file_name='South Horizons & Lei Tung_sentiment_comparison_1500_meter_annulus.png')
    south_horizons_1500_control.line_map_comparison(
        line_labels=('Treatment Group', 'Control Group(1500 meter)'),
        ylabel='Number of Posted Tweets(log10)',
        draw_sentiment=False,
        plot_title_name='South Horizons & Lei Tung Treatment Group and Control Group Comparison',
        saving_path=plot_saving_path,
        saving_file_name='South Horizons & Lei Tung_activity_comparison_1500_meter_annulus.png')

    ocean_park_1500_control.line_map_comparison(
        line_labels=('Treatment Group', 'Control Group(1500 meter)'),
        ylabel='Percentage of Positive Tweets Minus Percentage of Negative Tweets',
        draw_sentiment=True,
        plot_title_name='Ocean Park & Wong Chuk Hang Treatment Group and Control Group Comparison',
        saving_path=plot_saving_path,
        saving_file_name='Ocean Park & Wong Chuk Hang_sentiment_comparison_1500_meter_annulus.png')
    ocean_park_1500_control.line_map_comparison(
        line_labels=('Treatment Group', 'Control Group(1500 meter)'),
        ylabel='Number of Posted Tweets(log10)',
        draw_sentiment=False,
        plot_title_name='Ocean Park & Wong Chuk Hang Treatment Group and Control Group Comparison',
        saving_path=plot_saving_path,
        saving_file_name='Ocean Park & Wong Chuk Hang_activity_comparison_1500_meter_annulus.png')
